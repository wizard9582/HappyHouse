			...
			<ul class="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
				<li class="nav-item">
					<a
						...
						id="all-category"
					>
						<i class="icon-layers mr-1"></i><span class="d-none d-md-block">필독</span>
					</a>
				</li>
				<li class="nav-item">
					<a
						...
						id="note-business"
					>
						<i class="icon-briefcase mr-1"></i><span class="d-none d-md-block">공지사항</span></a
					>
				</li>
				<li class="nav-item">
					<a
						...
						id="note-social"
					>
						<i class="icon-share-alt mr-1"></i><span class="d-none d-md-block">이벤트</span></a
					>
				</li>
				<li class="nav-item">
					<a
						...
						id="note-important"
					>
						<i class="icon-tag mr-1"></i><span class="d-none d-md-block">자주묻는질문</span></a
					>
				</li>
				<li class="nav-item ml-auto">
					<a
						...
						id="add-notes"
					>
						<i class="icon-note m-1"></i><span class="d-none d-md-block font-14">1대1 문의</span></a
					>
				</li>
			</ul>
				...
				<div id="note-full-container" class="note-has-grid row">
					<div class="col-md-4 single-note-item all-category" style="">
						<div class="card card-body">
							...
							<p class="note-date font-12 text-muted">2021년 5월 24일</p>
					...
					<div class="col-md-4 single-note-item all-category note-social" style="">
						<div class="card card-body">
							...
							>
								Meeting with Mr.Jojo <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
					...
					<div class="col-md-4 single-note-item all-category note-business" style="">
						<div class="card card-body">
							...
							>
								Give Review for design <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
					...
					<div class="col-md-4 single-note-item all-category note-social" style="">
						<div class="card card-body">
							...
							>
								Nightout with friends <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
					...
					<div class="col-md-4 single-note-item all-category note-important" style="">
						<div class="card card-body">
							...
							<h5 class="note-title text-truncate w-75 mb-0" data-noteheading="Launch new template">
								Launch new template <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
					...
					<div class="col-md-4 single-note-item all-category note-business" style="">
						<div class="card card-body">
							...
							>
								Give review for foods <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
					...
					<div class="col-md-4 single-note-item all-category note-important" style="">
						<div class="card card-body">
							...
							>
								Give salary to employee <i class="point fa fa-circle ml-1 font-10"></i>
							</h5>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content border-0">
						...
						<div class="modal-footer">
							<button id="btn-n-save" class="float-left btn btn-success" style="display: none">
								Save
							</button>
